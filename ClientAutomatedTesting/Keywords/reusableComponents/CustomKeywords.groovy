...
public class CustomKeywords {
	...
	public static void fillConcessionalPsgnDtlsInQB(List<InputSinglePsgnDtls> psgnDtlsList ) {
		...
		for (int psgnCount = GlobalVariable.psgnCountStart; psgnCount <=  psgnDtlsList.size(); psgnCount++) {
			...
			if (psgnDtlsList.get(psgnCount-1).getIdCardType().trim().length()>0) {
				...
				System.out.println("divIdCardToBeClicked in GUI=" + divIdCardToBeClicked)
				...
				for (int idCardTypeCount = GlobalVariable.idCardCountStart; idCardTypeCount <= GlobalVariable.maxIdCardType; idCardTypeCount++) {
					...
					String span_idCardType = 'Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_PsgnDtls/IDCardType'+ idCardTypeCount
					System.out.println("span_idCardType in GUI=" + span_idCardType)
	...
	public static void fillAddDtlsClickNextInPsgnDtlPageQB(String concessionFlag,String mobileNo , String paymentType) {
		...
		if (concessionFlag.equals('Y')) {
			...
			WebUI.waitForElementPresent(findTestObject('Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_PsgnDtls/input_mobileNo'),
					GlobalVariable.waitForElementPresent,FailureHandling.OPTIONAL)
			System.out.println('mobile no =' + mobileNo)
			WebUI.click(findTestObject('Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_PsgnDtls/input_mobileNo'))
			WebUI.setText(findTestObject('Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_PsgnDtls/input_mobileNo'), mobileNo)

			System.out.println('enter mobile no =' + mobileNo)
		}
		...
		if (WebUI.waitForElementPresent(findTestObject('Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_PsgnDtls/input_Captcha'),
		GlobalVariable.waitForElementPresent,FailureHandling.OPTIONAL)){

			String captcha = CustomKeywordsForBooking.capchaInputDialog()
			WebUI.setText(findTestObject('Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_PsgnDtls/input_Captcha'), captcha)
	...
	public static  getBookedTktDtlsClickNextQB(String testCaseId , String noOfPsgn,BookedTktPnrDtls bookedTktPnrDtls) {
		...
		//	WebUI.delay(GlobalVariable.sleepTimeInSec)
		System.out.println('\n\nCLICKING PROCEED \n\n' )
		WebUI.click(findTestObject('Object Repository/NxtGenPRS_OR/BookingPage/QB_JourneyDtls/QB_DispTktDtls/button_ProceedPrint'))
		WebUI.delay(GlobalVariable.sleepTimeInSec)
		//	WebUI.delay(GlobalVariable.sleepTimeInSec)
		//	WebUI.delay(GlobalVariable.sleepTimeInSec)

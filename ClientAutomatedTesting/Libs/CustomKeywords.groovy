...
def static "reusableComponents.CustomKeywords.getBookedTktDtlsClickNextQB"(
    	String testCaseId	
     , 	String noOfPsgn	
     , 	BookedTktPnrDtls bookedTktPnrDtls	) {
    (new reusableComponents.CustomKeywords()).getBookedTktDtlsClickNextQB(
        	testCaseId
         , 	noOfPsgn
         , 	bookedTktPnrDtls)
}
...
def static "reusableComponents.CustomKeywords.writeBookedTktDtls"(
    	String outFileWithoutExtn	
     , 	java.util.List<BookedTktPnrDtls> bookedTktPnrDtlsList	) {
...
def static "reusableComponents.CustomKeywordsForEnquiry.fillDtlsOfFareEnqWithClusterStn"(
    	String trainNo	
     , 	String journeyDate	
     , 	String srcCode	
     , 	String destnStnCode	
     ...
     , 	String returnClass	) {
    (new reusableComponents.CustomKeywordsForEnquiry()).fillDtlsOfFareEnqWithClusterStn(
        	trainNo
         , 	journeyDate
         , 	srcCode
         , 	destnStnCode
